...
public class Estadistica {
    ...
    // MÉTODO HISTOGRAMA
    public static void histograma(double[] muestra) {

        int[] frecuencias = new int[5];

        for (double val : muestra) {
            if (val >= 5 && val < 6) frecuencias[0]++;
            else if (val >= 6 && val < 7) frecuencias[1]++;
            else if (val >= 7 && val < 8) frecuencias[2]++;
            else if (val >= 8 && val < 9) frecuencias[3]++;
            else if (val >= 9 && val <= 10) frecuencias[4]++;
        }

        System.out.println("\nHISTOGRAMA DE FRECUENCIAS:");
        System.out.println("5 - 6  : " + "*".repeat(frecuencias[0]));
        System.out.println("6 - 7  : " + "*".repeat(frecuencias[1]));
        System.out.println("7 - 8  : " + "*".repeat(frecuencias[2]));
        System.out.println("8 - 9  : " + "*".repeat(frecuencias[3]));
        System.out.println("9 - 10 : " + "*".repeat(frecuencias[4]));
    }
}